...
struct cereal_DriverMonitoring;
struct cereal_Boot;
...
typedef struct {capn_ptr p;} cereal_DriverMonitoring_ptr;
...
typedef struct {capn_ptr p;} cereal_DriverMonitoring_list;
...
static const size_t cereal_ThermalData_word_count = 6;

static const size_t cereal_ThermalData_pointer_count = 1;

static const size_t cereal_ThermalData_struct_bytes_count = 56;
...
static const size_t cereal_DriverMonitoring_word_count = 4;

static const size_t cereal_DriverMonitoring_pointer_count = 5;

static const size_t cereal_DriverMonitoring_struct_bytes_count = 72;
...
enum cereal_Event_which {
	...
	cereal_Event_driverMonitoring = 58,
...
struct cereal_Event {
	...
	union {
		...
		cereal_DriverMonitoring_ptr driverMonitoring;
...
cereal_DriverMonitoring_ptr cereal_new_DriverMonitoring(struct capn_segment*);
...
cereal_DriverMonitoring_list cereal_new_DriverMonitoring_list(struct capn_segment*, int len);
...
void cereal_read_DriverMonitoring(struct cereal_DriverMonitoring*, cereal_DriverMonitoring_ptr);
...
void cereal_write_DriverMonitoring(const struct cereal_DriverMonitoring*, cereal_DriverMonitoring_ptr);
...
void cereal_get_DriverMonitoring(struct cereal_DriverMonitoring*, cereal_DriverMonitoring_list, int i);
...
void cereal_set_DriverMonitoring(const struct cereal_DriverMonitoring*, cereal_DriverMonitoring_list, int i);
